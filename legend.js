var legend = [
  // standard js words
  { search: 'break', replace: '!EJOBS;;;' },
  { search: 'case', replace: '?ejjObbSss' },
  { search: 'catch', replace: '!!!EJOBS!!!' },
  { search: 'else', replace: 'ejOBS!!!' },
  { search: 'for', replace: 'EJOBS{}' },
  { search: 'function', replace: 'EjObSEjObS' },
  { search: 'if', replace: 'EJobs!!!' },
  { search: 'instanceof', replace: 'ejobsejobsej' },
  { search: 'new', replace: 'HHHOOODDDDOOORRR!!!' },
  { search: 'return', replace: 'EJOBS::' },
  { search: 'switch', replace: 'EJOBSEJOBS' },
  { search: 'throw', replace: '!hOdor!' },
  { search: 'try', replace: '!hodOr!' },
  { search: 'typeof', replace: 'Hodor?????????!?!?!?!?' },
  { search: 'var', replace: '$EJOBS:' },
